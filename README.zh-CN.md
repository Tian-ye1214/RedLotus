...
`1.0.1.post1` 候选（发布标题 `1.0.1-release`）正在 develop 完成整改和验收，尚未发布。本轮明确豁免 Linux、macOS、真实 QQ／微信账号及未配置模型协议的真实验收；对应功能保留，标记本轮未验证。其余验收仍须完成，见[当前验收记录](docs/design.md#状态说明)。
