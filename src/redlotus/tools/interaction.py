"""User input references, task state, and review decisions."""
...
class TaskManager:
    ...
    def create_todo_list(self, tasks_json: str) -> str:
        """Add id/description/dependencies JSON objects without discarding existing progress."""
        try:
    ...
    def get_todo_list(self) -> str:
        """Get task definitions, dependencies and current progress."""
        if not self.tasks:
