...
async def generate_image_from_flux(prompt: str, width: int | None = None, height: int | None = None, max_wait_time: float | None = None):
    """Submit, poll and download within one cancellable deadline; return image data or an error."""
