...
from redlotus.prompt import get_skills_as_in_system_prompt
...
from redlotus.cli.panel import build_panel_snapshot, render_panel
from redlotus.cli.completion import COMMAND_HELP
...
def _conversation_session_key(system: Any) -> str | None:
    return system._session_logs.session_key()
...
class SlashCommands:
    ...
    async def cd(self):
        ...
        await self.system.switch_workspace(target)
